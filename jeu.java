...
public class jeu extends JFrame{
	...
	pioche_4.setBounds(485, 100,60,45);
	JButton pioche_5 = new JButton("5");
	pioche_5.setBounds(275, 150,60,45);
	JButton pioche_6 = new JButton("6");
	pioche_6.setBounds(345, 150,60,45);
	JButton pioche_7 = new JButton("7");
	pioche_7.setBounds(415, 150,60,45);
