...
public class panel extends JPanel{
	...
	//Initialisation de l'Integer "nombre"  
	public static int nombre = 0;
	
	// Boutons + label pour les joueurs
	...
	// ComboBox pour le choix du nombre de joueurs
	JComboBox<Integer> choix_nombre_joueurs = new JComboBox<Integer>();
	
	
	public panel() {
	
		//Ajout d'un Listener sur le bouton "jouer" pour ouvrir fenetre jouer
